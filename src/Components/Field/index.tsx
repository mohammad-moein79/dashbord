      ...
      <div className="">
        ...
        <div className="relative">
          {textarea ? (
            ...
            <input
              className={twMerge(
                `w-full h-13 px-3.5 bg-n-2 border-2 border-n-2 rounded-xl   text-n-7 outline-none transition-colors placeholder:text-n-4/50 focus:bg-transparent dark:bg-n-5/50 dark:border-n-5/50 dark:text-n-3  ${
                  icon && "pl-[3.125rem]"
                } ${
                  value !== "" && "bg-transparent border-n-3/50"
                } ${classInput}`
