...
const MultiSelect = ({
  ...
  const customStyles = {
    control: (provided: any) => ({
      ...provided,
      "&:hover": {
        borderColor: theme === "dark" ? "rgb(52 56 57 / 0.5)" : "#F3F5F7",
      },
      overflow: "hidden",
      borderRadius: "8px",
      borderColor: theme === "dark" ? "rgb(52 56 57 / 0.5)" : "#F3F5F7",
      borderWidth: "2px",
      padding: "6px",
      backgroundColor: theme === "dark" ? "#141718" : "#fff", // تغییر رنگ پس زمینه کل کنترل
    }),
    input: (provided: any) => ({
      ...provided,
      color: "#333",
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      />
      <Icon
        className={`absolute top-[50%] translate-y-[-50%] left-4 w-5 h-5 pointer-events-none fill-n-4/50 dark:fill-n-4/75 ${
