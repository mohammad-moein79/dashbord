      ...
      {({ open }) => (
        <>
          ...
          >
            ...
            {value?.icon && (
              <Icon className="w-5 h-5 mr-3 dark:fill-n-1" name={value.icon} />
            )}
          ...
          >
            <Listbox.Options
              className={twMerge(
                `absolute left-0 top-16 right-0 w-full min-h-14 mt-12 p-2 bg-n-1 rounded-lg shadow-[0_0_1rem_0.25rem_rgba(0,0,0,0.04),0_2rem_2rem_-1.5rem_rgba(0,0,0,0.1),inset_0_0_0_0.0625rem_#E8ECEF] outline-none dark:shadow-[0_0_1rem_0.25rem_rgba(0,0,0,0.04),0_2rem_2rem_-1.5rem_rgba(0,0,0,0.1),inset_0_0_0_0.0625rem_#343839] dark:bg-n-6 ${
