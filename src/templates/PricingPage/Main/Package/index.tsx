...
const Package = ({ plan, item }: PackageProps) => (
  <div
    className={`flex basis-1/3  rounded-3xl  border-r-2 border-n-3 p-8 bg-n-1 first:rounded-l-3xl last:rounded-r-3xl last:border-none 2xl:px-6 lg:shrink-0 lg:basis-[18.5rem] dark:bg-n-7 dark:border-n-6 ${
      item.popular &&
